    ...
    <Section id="integrations" tone="subtle">
      <Container size="wide">
        <SectionHeader
          ...
          description="Most advisers tell you to throw out what you've built and start over. We don't. Whether your stack is a 1990s ERP, modern cloud services, or fifteen years of operational spreadsheets - that's where we begin."
        />
